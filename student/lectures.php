...
<head>
    ...
    <title>Lectures - Smart Tutor</title>
                    ...
                    <?php if ($materials && $materials->num_rows > 0): ?>
                        <?php while ($material = $materials->fetch_assoc()): ?>
                            <div class="material-card">
                                <div class="material-type-badge type-lecture">Lecture</div>
                                ...
                                <?php if ($material['file_path']): ?>
                                    ...
                                    $file_icon = in_array(strtolower($file_ext), ['pdf']) ? '📄 View PDF' : '📝 Download Lecture';
                                    ?>
                                    <a href="../uploads/lecture/<?php echo htmlspecialchars($material['file_path']); ?>" 
